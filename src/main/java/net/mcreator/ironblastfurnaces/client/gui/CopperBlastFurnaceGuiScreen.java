...
public class CopperBlastFurnaceGuiScreen extends AbstractContainerScreen<CopperBlastFurnaceGuiMenu> implements IronblastfurnacesModScreens.ScreenAccessor {
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	private boolean menuStateUpdateActive = false;

	public CopperBlastFurnaceGuiScreen(CopperBlastFurnaceGuiMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("ironblastfurnaces:textures/screens/copper_blast_furnace_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.ironblastfurnaces.copper_blast_furnace_gui.label_kiln"), 37, 4, -13421773, false);
	}
