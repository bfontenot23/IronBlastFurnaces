...
public class KilnSmeltingRecipe implements Recipe<RecipeInput> {
	private final List<ItemStack> output;
	private final NonNullList<Ingredient> recipeItems;
	private final List<String> strings;

	public KilnSmeltingRecipe(List<ItemStack> output, NonNullList<Ingredient> recipeItems, List<String> strings) {
		this.output = output;
	...
	public static class Type implements RecipeType<KilnSmeltingRecipe> {
		...
		public static final RecipeType<KilnSmeltingRecipe> INSTANCE = new Type();
	}

	public static class Serializer implements RecipeSerializer<KilnSmeltingRecipe> {
		public static final Serializer INSTANCE = new Serializer();
		private static final MapCodec<KilnSmeltingRecipe> CODEC = RecordCodecBuilder
				...
				}, DataResult::success).forGetter(recipe -> recipe.recipeItems), Codec.STRING.listOf().fieldOf("strings").forGetter(recipe -> recipe.strings)).apply(builder, KilnSmeltingRecipe::new));
		public static final StreamCodec<RegistryFriendlyByteBuf, KilnSmeltingRecipe> STREAM_CODEC = StreamCodec.of(Serializer::toNetwork, Serializer::fromNetwork);
		...
		private static KilnSmeltingRecipe fromNetwork(RegistryFriendlyByteBuf buf) {
			...
			return new KilnSmeltingRecipe(outputs, inputs, strings);
		}
